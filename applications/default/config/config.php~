...
$CONFIG['default']['base_url'] = 'http://localhost/codekir-cms/';
$CONFIG['default']['root_path'] = $_SERVER['DOCUMENT_ROOT'].'/codekir-cms/';

$CONFIG['default']['upload_path'] = $_SERVER['DOCUMENT_ROOT'].'/codekir-cms/tmp/';
